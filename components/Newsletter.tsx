const Newsletter = () => {
  ...
  return (
    <div className="w-full bg-gray-500" style={styles}>
      <div className="container flex flex-col flex-wrap content-center justify-center p-4 py-20 mx-auto md:p-10">
        ...
        <div className="flex flex-row">
          <input
            ...
            className="w-3/5 p-3 rounded-l-lg sm:w-2/3 outline-none"
          />
          <button
            type="button"
            className="w-2/5 p-3 font-semibold rounded-r-lg sm:w-1/3 bg-gray-200 hover:text-white hover:bg-black"
          >
            Subscribe
          </button>
        </div>
